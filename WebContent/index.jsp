	...
	<main role="main">
	  ...
	  <div class="jumbotron" >
	    ...
	    <div class="container">
	      ...
	      <p><a class="btn btn-primary btn-lg" href="ListCategorieServlet" role="button">Vai alla Lista di categorie &raquo;</a></p>
	      <p><a class="btn btn-primary btn-lg" href="PrepareSearchArticoloServlet" role="button">Cerca articolo &raquo;</a></p>
	      <p><a class="btn btn-primary btn-lg" href="PrepareSearchCategoriaServlet" role="button">Cerca categoria &raquo;</a></p>
	      </c:if>
