...
<body>
	<jsp:include page="../navbar.jsp" />
	 ...
	 <c:if test = "${ empty sessionScope.oggettoSessione or sessionScope.oggettoSessione.getRuolo() eq 'guest' }"> 
	...
	<main role="main" class="container">
		...
		<div class='card'>
		    ...
		    <div class='card-body'>
					...
					<form method="post" action="${pageContext.request.contextPath}/ExecuteInsertArticoloServlet" class="needs-validation" novalidate>
					
					<div class="form-row">
							<div class="form-group col-md-6">
								<input type="hidden" name="idCategoria" id="idCategoria" class="form-control"  value="${requestScope.idCategoria}" required >
							</div>
						</div>
						...
						<div class="form-row">
							...
							<div class="form-group col-md-6">
								...
								<div class="invalid-tooltip">Inserisci descrizione valida.</div>
							</div>
						</div>
