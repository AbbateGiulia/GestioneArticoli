...
/**
 * Servlet implementation class VisualizzaSoloArticoloServlet
 */
@WebServlet("/VisualizzaSoloArticoloServlet")
public class VisualizzaSoloArticoloServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public VisualizzaSoloArticoloServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("articolo/showarticolo.jsp");
