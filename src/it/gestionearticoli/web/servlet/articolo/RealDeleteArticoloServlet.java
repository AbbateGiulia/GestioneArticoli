...
/**
 * Servlet implementation class RealDeleteArticoloServlet
 */
@WebServlet("/RealDeleteArticoloServlet")
public class RealDeleteArticoloServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public RealDeleteArticoloServlet() {
		super();
