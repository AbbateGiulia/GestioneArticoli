...
/**
 * Servlet implementation class PrepareUpdateSoloArticoloServlet
 */
@WebServlet("/PrepareUpdateSoloArticoloServlet")
public class PrepareUpdateSoloArticoloServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public PrepareUpdateSoloArticoloServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher("articolo/updatearticolo.jsp");
